...
COIN_TGZ='https://github.com/puredev321/pure/archive/v1.0.0.4.tar.gz'
...
function important_information() {
 ...
 echo -e "Use ${RED}$COIN_CLI masternode status${NC} to check your MN. If you get ${RED}status 9${NC}, your node is up and running."
